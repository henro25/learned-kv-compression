...
# ./run_experiments.sh "Qwen/Qwen2.5-7B"  "8 16 32" "1 10 100 1000 3000" "5" "10000" "64" "2"
...
salloc -p gpu -t 0-2:00:00 --mem 160GB --gres=gpu:nvidia_a100-sxm4-80gb:1
cuda/12.4.1-fasrc01
cudnn/9.5.1.17_cuda12-fasrc01